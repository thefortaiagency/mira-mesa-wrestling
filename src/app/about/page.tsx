...
const currentStaff = [
  ...
  { name: "Davon Copeland", role: "Assistant Coach", photo: "/images/staff/davon.jpg", bullets: ["Years coaching: 15", "Education: BS Psychology, Master Human Service Counseling, MBA", "Fall Guys Coach", "1999 MMHS Alumni", "SDS Masters Placer", "2024 CIF Championship Team", "3× IBJJF Heavyweight/Absolute Champion", "IBJJF Pans Runner-Up", "3rd Place IBJJF World Championship", "Multiple World League Heavyweight/Absolute Champion", "US Navy Retired Gunner Mate Senior Chief"] },
  { name: "Fazil Bagirov", role: "Assistant Coach", photo: "/images/staff/fazil.jpg", bullets: ["Years coaching: 3", "Years at Mira Mesa: 2", "Education: Bachelor of Mechanical Engineering", "MMWC Freestyle Coach", "2× International Tana Cup Silver Medalist", "2× Northwestern Federal District Bronze Medalist", "5× Petrozavodsk City Champion"] },
  { name: "Isaac Pumarejo", role: "Fall Guys Head Coach", photo: "/images/staff/placeholder.jpg", bullets: ["Years coaching: 30", "Fall Guys Head Coach 2025-present", "Team Puma Head Coach", "2× CA State Placer", "Coached at Fresno City College", "Coached at Menlo College", "Club Coach — Fresno State", "Club Coach — Fresno Pacific", "Coached 7 future Cadet World Team members"] },
